...
SC_MODULE(Alexnet) {
    ...
    sc_buffer<float*> img_padding_o;
    sc_buffer<float*> conv1_output_o;
    sc_buffer<float*> conv2_output_o;
    sc_buffer<float*> conv34_output_o;
    sc_buffer<float*> conv5_output_o;
    sc_buffer<float*> fc6_output_o;
    sc_buffer<float*> fc7_output_o;
    sc_buffer<float*> fc8_output_o;

    sc_buffer<bool> start_pad;
    sc_buffer<bool> pad_conv1_valid;
    sc_buffer<bool> conv1_conv2_valid;
    sc_buffer<bool> conv2_conv34_valid;
    sc_buffer<bool> conv34_conv5_valid;
    sc_buffer<bool> conv5_fc6_valid;
    sc_buffer<bool> fc6_fc7_valid;
    sc_buffer<bool> fc7_fc8_valid;
    sc_buffer<bool> fc8_out_valid;
