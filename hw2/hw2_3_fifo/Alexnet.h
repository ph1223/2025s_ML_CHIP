...
SC_MODULE(Alexnet) {
    ...
    sc_fifo<float*> img_padding_o;
    sc_fifo<float*> conv1_output_o;
    sc_fifo<float*> conv2_output_o;
    sc_fifo<float*> conv34_output_o;
    sc_fifo<float*> conv5_output_o;
    sc_fifo<float*> fc6_output_o;
    sc_fifo<float*> fc7_output_o;
    sc_fifo<float*> fc8_output_o;

    sc_fifo<bool> start_pad;
    sc_fifo<bool> pad_conv1_valid;
    sc_fifo<bool> conv1_conv2_valid;
    sc_fifo<bool> conv2_conv34_valid;
    sc_fifo<bool> conv34_conv5_valid;
    sc_fifo<bool> conv5_fc6_valid;
    sc_fifo<bool> fc6_fc7_valid;
    sc_fifo<bool> fc7_fc8_valid;
    sc_fifo<bool> fc8_out_valid;
