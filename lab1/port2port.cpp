//############################################################################
//   2025 MLCHIP Spring Course
//   Lab02         : Port 2 Port Communication
//   Author        : HsuChiChen (chenneil90121@gmail.com)
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
//   Date          : 2024.03.13
//   Version       : v3.0, captible with gcc (GCC) 4.8.5 20150623 (Red Hat 4.8.5-44)
...
SC_MODULE(MODULE1) {
    ...
    void writer() {
        ...
        while (true) {
            ...
            ostringstream ss;
            string write_data;
            ss << (int)sc_time_stamp().to_seconds();
            write_data += ss.str();
...
SC_MODULE(CHECKER) {
    ...
    ~CHECKER() {
        if(correct_count == CORRECT_COUNT) {
            ...
            cout << "\033[35m" << "Congratulations! You have passed the test" << "\033[0m" << endl;
        } else {
